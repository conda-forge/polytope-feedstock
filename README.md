...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/polytope-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13513&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/polytope-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `polytope` can be installed with:

```
conda install polytope
```

It is possible to list all of the versions of `polytope` available on your platform with:
